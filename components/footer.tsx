...
/>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="text-gray-600 hover:text-[#37C3FF] transition-colors"
              >
          ...
          {/* Menu */}
          <div>
            <h3 className="font-semibold mb-4 text-black">Menü</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/" className="text-gray-600 hover:text-[#37C3FF] transition-colors">
                  Anasayfa
                </Link>
              </li>
              <li>
                <Link href="/hakkimizda" className="text-gray-600 hover:text-[#37C3FF] transition-colors">
                  Hakkımızda
                </Link>
              </li>
              <li>
                <Link href="/urunler" className="text-gray-600 hover:text-[#37C3FF] transition-colors">
                  Ürünler
                </Link>
              </li>
              <li>
                <Link href="/referanslar" className="text-gray-600 hover:text-[#37C3FF] transition-colors">
                  Referanslar
                </Link>
              </li>
              <li>
                <Link href="/iletisim" className="text-gray-600 hover:text-[#37C3FF] transition-colors">
                  İletişim
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold mb-4 text-black">İletişim</h3>
          ...
          {/* MvM UPS Elektronik */}
          <div>
            <h3 className="font-semibold mb-4 text-black">MvM UPS Elektronik</h3>
